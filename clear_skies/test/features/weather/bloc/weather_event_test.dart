...
void main() {
  group('WeatherEvent', () {
    ...
    test('WeatherLocationRequested supports value equality', () {
      final event1 = const WeatherLocationRequested(latitude: 51.5, longitude: -0.12, cityName: 'London');
      final event2 = const WeatherLocationRequested(latitude: 51.5, longitude: -0.12, cityName: 'London');
      final event3 = const WeatherLocationRequested(latitude: 48.8, longitude: 2.35, cityName: 'Paris');
