  ...
  group('WeatherDisplay', () {
    ...
    Widget createWidgetUnderTest() {
      return BlocProvider<FavoritesBloc>.value(
        ...
        child: MaterialApp(
          home: Scaffold(body: WeatherDisplay(weather: mockWeather)),
        ),
      );
    }

    testWidgets('renders weather information correctly', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('favorite icon is filled when city is in favorites', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets(
      'tapping favorite icon dispatches RemoveFavorite if already favorited',
    ...
    testWidgets(
      'tapping favorite icon dispatches AddFavorite if not favorited',
      (WidgetTester tester) async {
        when(() => mockFavoritesBloc.state).thenReturn(const FavoritesState());
