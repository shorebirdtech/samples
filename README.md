...
Welcome to the **Shorebird Samples** repository! This is a collection of sample applications and demonstrations showcasing how to integrate and use [Shorebird](https://shorebird.dev) across various real-world Flutter architectures.
...
| Sample | Description |
|---|---|
| [**Flavors**](./flavors) | Demonstrates how to configure Shorebird in a Flutter app that uses standard flavors. |
| [**Multi-Dimensional Flavors**](./multi_dimensional_flavors) | A more advanced setup showcasing Shorebird with multiple, multi-dimensional flavors on Android. |
...
1. **Install Shorebird:** If you haven't already, install the Shorebird CLI by following the [getting started guide](https://docs.shorebird.dev/).
...
- [Official Shorebird Documentation](https://docs.shorebird.dev/)
- [Shorebird Website](https://shorebird.dev)
